...
public class BirdTest {
  private static final String TO_STRING_INCORRECT = "toString() method is incorrect";
    ...
    public void testAccept() {
      ...
      Zoo.acceptBird(new Eagle(), birds);
      Zoo.acceptBird(new Swallow(), birds);
